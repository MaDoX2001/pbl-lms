# Create Project 2: Traffic Light Simulation
...
$projectJson = Get-Content -Path "$scriptDir\project-2-data.json" -Encoding UTF8 -Raw
$groupCardJson = Get-Content -Path "$scriptDir\project-2-group-card.json" -Encoding UTF8 -Raw
$individualCardJson = Get-Content -Path "$scriptDir\project-2-individual-card.json" -Encoding UTF8 -Raw

# ==================== Script Execution ====================

Write-Host "`n=== Creating Project 2: Traffic Light Simulation ===" -ForegroundColor Cyan
...
Write-Host "`n✅ Project 2 setup complete!" -ForegroundColor Green
...
Write-Host "  - Title: Traffic Light Simulation" -ForegroundColor White
Write-Host "  - Type: Team Project" -ForegroundColor White
Write-Host "  - Duration: 10 hours" -ForegroundColor White
Write-Host "  - Points: 100" -ForegroundColor White
Write-Host "  - Deadline: 2026-03-20" -ForegroundColor White
