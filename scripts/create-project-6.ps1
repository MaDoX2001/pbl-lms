# Create Project 6: Smart Environmental Monitoring & Decision System
...
$projectJson = Get-Content -Path "$scriptDir\project-6-data.json" -Encoding UTF8 -Raw
$groupCardJson = Get-Content -Path "$scriptDir\project-6-group-card.json" -Encoding UTF8 -Raw
$individualCardJson = Get-Content -Path "$scriptDir\project-6-individual-card.json" -Encoding UTF8 -Raw

# ==================== Script Execution ====================

Write-Host "`n=== Creating Project 6: Smart Environmental Monitoring & Decision System ===" -ForegroundColor Cyan
...
Write-Host "`n✅ Project 6 setup complete!" -ForegroundColor Green
...
Write-Host "  - Title: Smart Environmental Monitoring & Decision System" -ForegroundColor White
Write-Host "  - Type: Team Project" -ForegroundColor White
Write-Host "  - Level: Expert" -ForegroundColor White
Write-Host "  - Duration: 20 hours" -ForegroundColor White
Write-Host "  - Points: 200" -ForegroundColor White
Write-Host "  - Deadline: 2026-05-30" -ForegroundColor White
