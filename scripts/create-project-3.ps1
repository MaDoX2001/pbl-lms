# Create Project 3: Smart Light Using LDR
...
$projectJson = Get-Content -Path "$scriptDir\project-3-data.json" -Encoding UTF8 -Raw
$groupCardJson = Get-Content -Path "$scriptDir\project-3-group-card.json" -Encoding UTF8 -Raw
$individualCardJson = Get-Content -Path "$scriptDir\project-3-individual-card.json" -Encoding UTF8 -Raw

# ==================== Script Execution ====================

Write-Host "`n=== Creating Project 3: Smart Light Using LDR ===" -ForegroundColor Cyan
...
Write-Host "`n✅ Project 3 setup complete!" -ForegroundColor Green
...
Write-Host "  - Title: Smart Light Using LDR" -ForegroundColor White
Write-Host "  - Type: Team Project" -ForegroundColor White
Write-Host "  - Level: Intermediate" -ForegroundColor White
Write-Host "  - Duration: 12 hours" -ForegroundColor White
Write-Host "  - Points: 100" -ForegroundColor White
Write-Host "  - Deadline: 2026-04-05" -ForegroundColor White
