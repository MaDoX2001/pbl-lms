# Create Project 4: Smart Alarm System
...
$projectJson = Get-Content -Path "$scriptDir\project-4-data.json" -Encoding UTF8 -Raw
$groupCardJson = Get-Content -Path "$scriptDir\project-4-group-card.json" -Encoding UTF8 -Raw
$individualCardJson = Get-Content -Path "$scriptDir\project-4-individual-card.json" -Encoding UTF8 -Raw

# ==================== Script Execution ====================

Write-Host "`n=== Creating Project 4: Smart Alarm System ===" -ForegroundColor Cyan
...
Write-Host "`n✅ Project 4 setup complete!" -ForegroundColor Green
...
Write-Host "  - Title: Smart Alarm System" -ForegroundColor White
Write-Host "  - Type: Team Project" -ForegroundColor White
Write-Host "  - Level: Intermediate" -ForegroundColor White
Write-Host "  - Duration: 14 hours" -ForegroundColor White
Write-Host "  - Points: 100" -ForegroundColor White
Write-Host "  - Deadline: 2026-04-20" -ForegroundColor White
